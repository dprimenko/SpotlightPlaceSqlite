 ...
 */
public class InProgressFragment extends Fragment implements IPlaceListMvp.View, ApiDAO.AsyncApiRequestListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        llInProgress = (LinearLayout) view.findViewById(R.id.ll_in_progress);
        lwPlaces = (ListView) view.findViewById(R.id.lw_in_progress_places);

        adapter = new PlacesAdapter(getActivity(), R.layout.item_place, PlacesAdapter.IN_PROGRESS_ADAPTER);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                getActivity().runOnUiThread(new Runnable() {
                    public void run() {
                        if (checkDateTime(spotPlace.getmDateTimeFrom(), spotPlace.getmDateTimeTo()) == PlacesAdapter.IN_PROGRESS_ADAPTER) {
    ...
    public int checkDateTime(String from, String to) {
        ...
        try {
            ...
            if ((now.getTimeInMillis() >= dateFrom.getTime()) && (now.getTimeInMillis() <= dateFrom.getTime())) {
                Log.d("In", "progress");
